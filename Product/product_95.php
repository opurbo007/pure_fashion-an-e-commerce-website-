...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/shoes/shoes5.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1>>White Sneakers<br> By Nick</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="White Sneakers" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/shoes/shoes5.jpg" data-pure-item-id />
