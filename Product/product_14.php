...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/women/accessories/pro2.webp">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Colorful Bag <br> By Easy</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Colorful Bag" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/women/accessories/pro2.webp" data-pure-item-id>
