...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/accessories/black_watch2.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Blackchain watch</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Blackchain watch" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/accessories/black_watch2.jpg" data-pure-item-id />
