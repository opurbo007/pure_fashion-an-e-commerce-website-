...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/Shirt/shirt4.webp">
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Casual Shirt" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/Shirt/shirt4.webp" data-pure-item-id />
