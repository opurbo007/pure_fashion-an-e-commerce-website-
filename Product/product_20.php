...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/women/accessories/pro8.webp">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Black & White Bag <br> </h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Black & White Bag" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="60.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="./Img/product/women/accessories/pro8.webp" data-pure-item-id />
