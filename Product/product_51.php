...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/women/shoes/shoes3.webp">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Dark blue Heal</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Dark-blue Heal" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="87.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="./Img/product/women/shoes/shoes3.webp" data-pure-item-id />
