...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/women/Sharee/sharee9.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Navy-Blue Sharee</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Navy-Blue Sharee" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/women/Sharee/sharee9.jpg" data-pure-item-id />
