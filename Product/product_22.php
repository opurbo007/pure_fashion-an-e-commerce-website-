...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/women/Dress/Dress1.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> White Three-Pieces</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value=" White Three-Pieces" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="20.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="./Img/product/women/Dress/Dress1.jpg" data-pure-item-id />
