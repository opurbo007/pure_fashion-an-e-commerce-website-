...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/t-shirt/Tshirt2.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1>Gray T-Shirt <br> By Easy</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Gray T-Shirt" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/t-shirt/Tshirt2.jpg" data-pure-item-id />
