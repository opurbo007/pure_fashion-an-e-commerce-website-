        ...
        <div class="product">
            ...
            <div>
                <div class="productpage-2">
                    <h1>Black Sneaker <br> By Puma</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Black Sneaker" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="30.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="./Img/product-2.jpg" data-pure-item-id />
                        ...
                        <p>This is a Black Sneaker with black Design by Puma Brand. In this summer stay classy with Easy Brand</p>
                    </div>
                </div>
            </div>
        </div>
