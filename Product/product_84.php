...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/Shirt/shirt6.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Ash Colour shirt</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Ash Colour shirt" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/Shirt/shirt6.jpg" data-pure-item-id />
