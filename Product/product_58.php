...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/accessories/goldchain_watch.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1>Goldenchain watch</h1>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="button">
                            ...
                            <input type="hidden" value="Goldenchain watch" name="product_name" data-pure-attribute="">
                            ...
                            <input type="hidden" value="./Img/product/men/accessories/goldchain_watch.jpg" data-pure-item-id />
