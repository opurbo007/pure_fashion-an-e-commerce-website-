...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/accessories/black_cap.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Black X-Cap <br> By Easy</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Black X-cap " name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/accessories/black_cap.jpg" data-pure-item-id />
