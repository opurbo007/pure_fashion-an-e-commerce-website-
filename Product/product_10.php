        ...
        <div class="product">
            ...
            <div>
                <div class="productpage-2">
                    <h1> Black Sneakers <br> By Easy</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Black Sneakers" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="100.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="./Img/product-10.jpg" data-pure-item-id />
                        ...
                        <p>This is a Black Sneakers with black Design by Easy Brand. In this summer stay classy with Easy Brand</p>
                    </div>
                </div>
            </div>
        </div>
