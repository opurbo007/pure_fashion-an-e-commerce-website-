...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/women/pant/pant7.webp">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Red Jeans <br> By Easy</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Red Jeans" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="15.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="./Img/product/women/pant/pant7.webp" data-pure-item-id />
