...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/women/pant/pant2.webp">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Dark Blue Scott</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Dark Blue Scott" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/women/pant/pant2.webp" data-pure-item-id />
