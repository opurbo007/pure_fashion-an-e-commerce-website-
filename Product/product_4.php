        ...
        <div class="product">
            ...
            <div>
                <div class="productpage-2">
                    <h1> Dark-blue T-shirt <br> By Easy</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Dark-blue T-shirt" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product-4.jpg" data-pure-item-id />
