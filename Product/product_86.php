...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/Shirt/shirt8.webp">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Light Maroon Shirt</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Light Maroon Shirt" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="18.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="../Img/product/men/Shirt/shirt8.webp" data-pure-item-id />
