...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/women/Dress/Dress5.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Red Three-pieces</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Red Three-pieces" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/women/Dress/Dress5.jpg" data-pure-item-id />
