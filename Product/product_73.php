...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/pant/pant4.webp">

            </div>

            <div>
                <div class="productpage-2">
                    <h1>Black Formal pant</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Black Formal pant" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/pant/pant4.webp" data-pure-item-id />
