...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/accessories/silverchain_watch.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Silverchain watch</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Silverchain watch" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="89.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="./Img/product/men/accessories/silverchain_watch.jpg" data-pure-item-id />
