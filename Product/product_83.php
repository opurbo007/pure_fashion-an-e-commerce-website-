...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/Shirt/shirt5.webp">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Casual Dark Shirt <br> By RichMan</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Casual Dark Shirt" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="40.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="./Img/product/men/Shirt/shirt5.webp" data-pure-item-id />
