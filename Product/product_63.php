...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/accessories/blue_watch.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1>Dark Blue Watch</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Dark Blue Watch" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/accessories/blue_watch.jpg" data-pure-item-id />
