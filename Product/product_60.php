...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/accessories/glass2.jpg">
                        ...
                        <form action="" class="form" data-pure-form>
                            <div class="form-group">
                                <select class="form-control" name="observations" data-pure-attribute required>
                                  ...
                                  <option value="Red">Regular</option>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Men Glasses" name="product_name" data-pure-attribute="">
                                <input type="hidden" value="7.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="./Img/product/men/accessories/glass2.jpg" data-pure-item-id />
