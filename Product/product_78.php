...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/pant/pant9.webp">
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Black trouser" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/pant/pant9.webp" data-pure-item-id />
