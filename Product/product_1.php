                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Red T-shirt" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product-1.jpg" data-pure-item-id >
                        ...
                        <p>This is a Red T-shirt with black Design by Easy Brand. In this summer stay classy with Easy Brand</p>
                    </div>
                </div>
            </div>
        </div>
