...
?>
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/men/t-shirt/Tshirt7.jpg">

            </div>

            <div>
                <div class="productpage-2">
                    <h1> Light Black T-Shirt</h1>
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="Light Black T-Shirt" name="product_name" data-pure-attribute="">
                                ...
                                <input type="hidden" value="./Img/product/men/t-shirt/Tshirt7.jpg" data-pure-item-id />
