    ...
    <div class="container">
        ...
        <div class="product">
            ...
            <div class="productpage-1">
                <img src="../Img/product/women/shoes/shoes6.webp">
                    ...
                    <div class="card-footer">
                        <form action="" class="form" data-pure-form>
                            ...
                            <div class="button">
                                ...
                                <input type="hidden" value="63.00" name="unity_price" data-pure-attribute>
                                <input type="hidden" value="shirt" name="item_type" data-pure-attribute>
                                <input type="hidden" value="../Img/product/women/shoes/shoes6.webp" data-pure-item-id />
